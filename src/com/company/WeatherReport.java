...
public class WeatherReport {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            String userInputDay = myScanner.next();
            ...
            if ((userInputDay.equals("Sunday")) || (userInputDay.equals("Monday")) || (userInputDay.equals("Tuesday"))
                    || (userInputDay.equals("Wednesday")) || (userInputDay.equals("Thursday")) || (userInputDay.equals("Friday"))
                    || (userInputDay.equals("Saturday"))) {
